...
if __name__ == "__main__":
    ...
    dataset1 = dataset[["date","pred","n_ret","port_num"]].dropna()
    ...
    dataset2 = dataset2.loc[dataset2["universe.Date"] > date_min]
    dataset2 = dataset2.set_index("universe.Date")
    dataset2 = (1+dataset2[["universe.usd","universe.bist100","universe.bist100_usd"]]).cumprod().mul(100)
    dataset2 = dataset2.reset_index()
    dataset2["date"] = dataset2["universe.Date"]
